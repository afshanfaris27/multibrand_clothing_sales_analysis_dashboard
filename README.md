...
Total Quantity Sold: 449K,
Average Profit Margin: 30.19%
...
Treemap visualization showing product contribution based on Sales, Profit, and Margin
...
**Table:**
Profit Margin comparison by Brand

**Visual Analysis:**
Horizontal bar chart comparing Total Sales, Profit, and Margin by Customer Type and Brand,
Treemap highlighting Brand contribution based on Sales, Profit, and Margin
...
Average Age: 41,
Total Customers: 83.73K,
Average Purchase Frequency: 2.14

**Visual Analysis:**
Customer type distribution by Payment Method,
Sales, Profit, and Margin analysis by Age Group,
Seasonal trend analysis of Sales, Profit, and Margin by Age Group,
...
**Dataset Source**
Kaggle – Multiclass Clothing Sales Dataset
https://www.kaggle.com/datasets/rayzem/dynamic-apparel-sales-dataset-with-anomalies
